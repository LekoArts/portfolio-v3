...
~~I’m looking for a remote full stack software engineering role, in a team working in european or EST time zones. The company should have an entity in Germany or should be able to hire me through a payroll provider like [Remote](https://remote.com/). I’m open-minded about the type of company, working on open source (in any capacity) would be a plus. You can contact me via email at [hello@lekoarts.de](mailto:hello@lekoarts.de) or on [LinkedIn](https://www.linkedin.com/in/lennart-joergens/).~~
