...
description: "ls is a file-listing command that ships with Unix and Linux. exa is an improved file lister with better defaults, git integration, and colors. Here's how to use it."
date: 2022-02-10
...
> **exa is unmaintained**
>
> As of 2025 exa is unmaintained. You should use [eza](/garden/replacing-ls-with-eza/) instead.
