...
slug: how-i-used-theme-ui-to-seamlessly-convert-design-to-code
...
![Figma project showing screenshots of inspirational websites for creating the hero section. They are all quite colourful and have abstract "blob" shapes in them. Light color palette. The last screenshot shows the website of Refactoring UI.](./_img/figma-inspiration-websites.jpg)
...
![An illustration showing a stylized Gatsby site in the middle with four items around it. They each represent React components, Data Layer, Custom Data Sources, and other Gatsby Themes.](./_img/illustration.jpg)
...
![Screenshot of a split view. Left is Figma with the TailwindCSS preset as Figma styles, right is VS Code with the color palette inside a colors JS object (theme file).](./_img/figma-to-code.jpg)
