...
description: Make MDX components automatically available in MDX files without importing them each time. Pass custom components to the Content renderer in Astro pages.
date: 2024-07-26
...
```astro title="src/pages/[...slug].astro" ins={3} ins="components={{ Collapsible }}"
---
import { getCollection } from 'astro:content'
