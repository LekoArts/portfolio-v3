...
slug: adding-a-draft-feature-to-gatsby
description: "Learn how to use Gatsby's schema customization feature to add default values to your GraphQL schema. Through this you'll add a draft feature to your posts to hide work-in-progress content."
date: 2019-09-08
...
You can learn more about schema customization in Gatsby by reading my garden posts [Filter Future Posts on a Gatsby Blog](/filter-future-posts-on-a-gatsby-blog/) and [Adding Support for Multiple Authors in Gatsby](/adding-support-for-multiple-authors-in-gatsby/).
