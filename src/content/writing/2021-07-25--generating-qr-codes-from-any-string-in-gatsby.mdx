...
slug: generating-qr-codes-from-any-string-in-gatsby
...
Continue reading to learn how to do this! You can find the finished code on [Codesandbox](https://codesandbox.io/s/gatsby-qr-code-with-schema-customization-ldsc5) and you can also check out [Filter Future Posts on a Gatsby Blog](/filter-future-posts-on-a-gatsby-blog/) to see the API in a similar example.
