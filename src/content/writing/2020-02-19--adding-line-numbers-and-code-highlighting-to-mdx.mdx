...
In this very short quick tip you'll learn how to set up code blocks in [MDX](https://mdxjs.com/) and Gatsby that support line numbers and code highlighting using the code renderer [prism-react-renderer](https://github.com/FormidableLabs/prism-react-renderer). You can also combine this with the tip on [Adding Language Tabs](/language-tabs-for-markdown-and-mdx-code-blocks#mdx--prism-react-renderer/).
...
```js title="gatsby-config.mjs" {1, 5-12}
