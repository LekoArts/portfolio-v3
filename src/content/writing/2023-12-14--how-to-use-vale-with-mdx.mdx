...
description: Learn how you can configure Vale to lint your MDX files. Install Vale as an npm package and configure it to properly parse MDX syntax in your documentation.
date: 2023-12-14
