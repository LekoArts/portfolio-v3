...
slug: filter-future-posts-on-a-gatsby-blog
...
You can learn more about schema customization in Gatsby by reading my garden posts [Adding a Draft Feature to Gatsby](/adding-a-draft-feature-to-gatsby/).
