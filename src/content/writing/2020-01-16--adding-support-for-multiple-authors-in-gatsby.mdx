...
slug: adding-support-for-multiple-authors-in-gatsby
description: "Ever wanted to display multiple authors to a blog post in Gatsby? Learn how to link author data from YAML files to your posts and display their information."
date: 2020-01-16
...
You can learn more about schema customization in Gatsby by reading my garden posts [Adding a Draft Feature to Gatsby](/adding-a-draft-feature-to-gatsby/) and [Filter Future Posts on a Gatsby Blog](/filter-future-posts-on-a-gatsby-blog/).
