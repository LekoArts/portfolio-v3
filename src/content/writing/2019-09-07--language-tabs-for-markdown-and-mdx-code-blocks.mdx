...
slug: language-tabs-for-markdown-and-mdx-code-blocks
...
The following two quick tips explain how to integrate this feature with `gatsby-remark-prismjs` or `prism-react-renderer` (Markdown or MDX respectively). You can also check out the tip [Adding Line Numbers](/adding-line-numbers-and-code-highlighting-to-mdx/) to further improve your code blocks.
...
```css title="custom-prism-styles.css" showLineNumbers
.gatsby-highlight {
  position: relative;
...
Want to learn how to add line numbers to your code blocks? Read [Adding Line Numbers and Code Highlighting to MDX](/adding-line-numbers-and-code-highlighting-to-mdx/) to learn more.
