...
slug: cleaning-up-stale-branches
description: "Showcase of the handy CLI tool called git-removed-branches. It automatically detects and removes local branches that have been deleted from the remote repository."
date: 2022-02-10
