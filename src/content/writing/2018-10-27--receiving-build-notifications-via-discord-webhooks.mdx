...
You can also adapt this guide to send notifications of [GitHub Actions](/running-cypress-tests-with-github-actions-in-parallel/) to a discord channel of yours.
