...
description: A short explainer on how you can exclude test files and other unwanted files from your tsup build output using negative glob patterns in the entry field.
date: 2023-11-04
...
```ts title="tsup.config.ts" ins='"!src/**/__tests__/**"' ins='"!src/**/*.test.*"'
import { defineConfig } from "tsup"
...
> **Looking for tsdown?**
>
> Need a tsdown version of this? Read [tsdown: Excluding Files From the Build](/garden/tsdown-excluding-files-from-the-build/).
