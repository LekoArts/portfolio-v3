...
description: Guide on how to assert the logs and exitCode of your CLI program when using Jest & Vitest. Create custom matchers and invoke helpers for clean test assertions.
date: 2023-12-25
...
```ts title="tests/config.test.ts" {8}
