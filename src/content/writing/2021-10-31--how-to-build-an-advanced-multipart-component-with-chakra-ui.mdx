...
```tsx title="src/main.tsx" {3,5,9-11}
...
```ts title="src/theme.ts" {3,21} collapse={5-16}
import { extendTheme, ThemeConfig } from "@chakra-ui/react"
import Container from "./chakra/container"
...
The `percentageWidths` function inside `utils.ts` doesn't exist yet. Create a new file at `src/chakra/utils.ts`:
...
Edit the `utils.ts` file:

```ts title="src/chakra/utils.ts" collapse={8-24}
import {
  mode,
  transparentize,
  getColor,
...
```ts title="src/chakra/custom-container.ts" {3} collapse={5-15,20-99}
import { ComponentStyleConfig } from "@chakra-ui/react"
import InnerContainerStyles from "./container"
import { percentageWidths, variantSolid } from "./utils"
...
```ts title="src/chakra/utils.ts" collapse={1-62}
import {
  mode,
  transparentize,
  getColor,
...
```ts title="src/chakra/custom-container.ts" {3-8} collapse={10-24,32-99}
import { ComponentStyleConfig } from "@chakra-ui/react"
import InnerContainerStyles from "./container"
import {
  variantSolid,
...
```ts title="src/chakra/utils.ts" collapse={1-97}
import {
  mode,
  transparentize,
  getColor,
...
```ts title="src/chakra/custom-container.ts" {8} collapse={11-32,36-99}
import { ComponentStyleConfig } from "@chakra-ui/react"
import InnerContainerStyles from "./container"
import {
  variantSolid,
