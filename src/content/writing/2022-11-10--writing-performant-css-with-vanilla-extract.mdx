...
<Alert status="note" title="Intended audience">
...
<Alert status="note" title="globalStyle restrictions">
...
<Alert status="note" title="Abbreviated code blocks">
...
<Alert status="note" title="style() inputs">
...
<Alert status="note" title="vanilla-extract file names">
...
<Alert status="note" title="styleVariants mapping function">
...
<Alert status="note" title="Ways of defining properties">
...
<Alert status="note" title="Sprinkles: Usage">
