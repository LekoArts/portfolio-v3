...
description: Learn how to send notifications for your Duplicati backups to Discord through webhooks. Set up a Cloudflare worker to proxy Duplicati's HTTP notifications to Discord.
date: 2025-03-29
